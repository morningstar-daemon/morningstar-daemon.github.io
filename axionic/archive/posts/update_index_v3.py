...
def main():
    ...
    # Find the "Posts by Date" section and cut everything after it
    ...
    # Build new posts list (reverse chronological)
    posts_lines = [f"- {date} - {title}" for date, title in sorted(posts, reverse=True)]
    ...
    print(f"Updated index.md with {len(posts)} posts in YYYY-MM-DD - title format")
