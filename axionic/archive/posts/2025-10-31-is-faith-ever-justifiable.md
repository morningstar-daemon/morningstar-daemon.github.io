...
**1. The Frame**
Reiterates definition from "Against Faith":
"Faith is belief persistence within a model of an agent that resists calibration."
...
**2. Pragmatic Faith**
**Claim:** Faith necessary for action under uncertainty (taking risks, starting projects, falling in love)
...
**3. Epistemic Faith**
**Claim:** All reasoning rests on faith—faith in logic, reason, uniformity of nature
...
**4. Moral Faith**
**Claim:** Society requires faith in others—trust and cooperation depend on it
...
**5. Religious Faith**
**Claim:** Belief in things unseen; elevates epistemic rigidity into moral virtue
...
**6. Existential Faith**
**Claim:** Faith as existential necessity—will to affirm life despite absurdity (Kierkegaard, Camus)
...
1. State common defense of faith
2. Show it either:
...
3. Conclude that no defensible version of "faith" remains
...
1. **Charitable interpretation** of faith defense
2. **Reframe** using calibration criterion
3. **Show reduction** to either calibrated confidence or admitted pathology
4. **Verdict** that preserves insight while rejecting faith-label
