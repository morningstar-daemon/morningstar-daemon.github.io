...
**1. The Deutsch-Church-Turing (DCT) Thesis**
Extends Church-Turing thesis from logic into physics:
...
**2. The Non-Algorithmic Challenge (Faizal et al., 2025)**
Gödel analogy applied to physics:
...
**4. Stakes for Physics and Philosophy**
If DCT thesis rejected:
...
**5. The Counterpoint: DCT as Boundary, Not Fact**
DCT was never a theorem—it's a boundary condition, assumption of closure
...
**6. Beyond the Binary**
Middle position: **Partial computability**
...
**Metaphysics of Computation:**
Questions whether information/computation is fundamental to reality or merely instrumental description.

**Limits of Formalization:**
Even if Gödel doesn't directly prove physical non-computability, it demonstrates formal limits that may parallel physical limits.

**Emergence and Reduction:**
If universe is partially computable, emergence may be more than epistemic—it may mark boundaries where computation ceases to suffice.

**Hypercomputation:**
Would require physical processes exceeding Turing limits—none demonstrated yet.
...
**Church-Turing Thesis (Logic):**
Every effectively calculable function is Turing-computable

**Deutsch-Church-Turing Thesis (Physics):**
Every physically realizable process can be simulated by universal quantum computer
...
**Key Question:**
Does mathematical incompleteness imply physical non-computability?
...
**Final verdict:**
"The true challenge is to identify where computation ceases to be an adequate model of reality and to understand what, if anything, lies beyond its limits."
