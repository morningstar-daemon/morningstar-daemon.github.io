...
**Date:** 2025-11-19  
**URL:** https://axionic.org/posts/179372278.what-is-a-model.html  
...
Defining feature: generates expectations. Maps inputs to outputs, enabling prediction and explanation. Distinguishes models from mere observation lists.

**Compression & Generalization:**
Models often compress information, capturing regularities compactly. Enables generalization to novel cases. (Lookup tables = minimal models without compression)

**Interpretive Role:**
Attributing beliefs/desires/intentions = constructing model of agent's behavior. Different representational layer than agent's own regulatory architecture.
...
- [philosophy-of-science](../tags/philosophy-of-science.md)
