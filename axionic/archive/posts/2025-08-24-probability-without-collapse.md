...
- **Problem:** If all outcomes occur, why do we experience them with specific probabilities? Why does relative frequency follow the Born rule (|ψ|²)?
...
1. **Declare amplitudes to be probabilities** (Zurek's envariance): Attempts to show |ψ|² is objectively "the" probability measure built into Hilbert space. Elegant but conflates geometry of wavefunction with subjective experience of uncertainty.
...
**Measure (ontological):** Squared amplitude |ψ|² of a branch—quantifies "weight" in Hilbert space. This is objective structural fact about the wavefunction.
...
- **Born rule** – Probability = squared amplitude of wavefunction (|ψ|²)
...
- [embedded-agency](../tags/embedded-agency.md)
- [quantum-foundations](../tags/quantum-foundations.md)
