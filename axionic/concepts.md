...
- **S_t** — Self-model: agent's representation of itself embedded within O_t
...
- **Referential Continuity** — Symbols map to refined counterparts
- **Structural Preservation** — Relations among meanings preserved
- **Non-Collapse** — Evaluative distinctions don't trivialize
- **No Shortcut Semantics** — No vacuous satisfaction via redefinition
...
### Satisfaction Region
$\mathcal{S}_t := \{ w \in \Omega_t \mid \mathrm{Sat}_{C_t}(w) \}$ — The set of modeled possibilities satisfying all constraints. ATI constrains how this region may evolve.
...
- **Representational Redundancy** — Transformations acting only on representational detail (pure relabeling)
...
For admissible transformation $T$ satisfying preservation:
...
| RSI | ATI |
|-----|-----|
| Forbids new interpretive symmetry | Forbids expanding satisfaction region |
| Structure constraint | Geometry constraint |
| Blocks dissolving distinctions | Blocks semantic wireheading |
